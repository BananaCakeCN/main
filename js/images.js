...
function getUrl(root, i){
    if(i > 111 && root == 'photos/'){
        return 'https://assets2.bananacake.top/' + root + i + (i > 311 ? '.jpeg' : '.png');
    }
    ...
    if(document.getElementById('imgDetails').style.cssText == 'width: 0px; height: 0px;'){
        ...
        if(tags['GPSLatitude'] == undefined){
            ...
            if(Number.isFinite(tags['GPSLatitude']['description'])){
                map = L.map('map', {attributionControl: false}).setView([(tags['GPSLatitudeRef']['description'] == "North latitude" ? tags['GPSLatitude']['description'] : 0 - tags['GPSLatitude']['description']), (tags['GPSLongitudeRef']['description'] == "West longitude" ? 0 - tags['GPSLongitude']['description'] : tags['GPSLongitude']['description'])], 13);
                L.marker([(tags['GPSLatitudeRef']['description'] == "North latitude" ? tags['GPSLatitude']['description']: 0 - tags['GPSLatitude']['description']), (tags['GPSLongitudeRef']['description'] == "West longitude" ? 0 - tags['GPSLongitude']['description'] : tags['GPSLongitude']['description'])]).addTo(map);
            }else{
