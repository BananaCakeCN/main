...
async function imageDetails(root, index){
    if(document.getElementById('imgDetails').style.cssText == 'width: 0px; height: 0px;'){
        ...
        const tags = await ExifReader.load('https://assets.bananacake.top/photos/109.png');
